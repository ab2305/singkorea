...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(singkorea.singkorea.com.singkorea.R.layout.activity_main);

        Toolbar toolbar = (Toolbar) findViewById(singkorea.singkorea.com.singkorea.R.id.toolbar);
        ...
        // 웹뷰 세팅
        mWebView = (WebView)findViewById(singkorea.singkorea.com.singkorea.R.id.testWebView); //레이어와 연결
        setmWebSettings();
    ...
    public void runUriScheme(Uri uri) {
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, "Play Store not installed", Toast.LENGTH_SHORT).show();
        }
    }
