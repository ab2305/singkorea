...
public class MarketDetailParentModel {

    private String RESULT;
    private List<MaketDetailModel> LIST;
    ...
    public List<MaketDetailModel> getLIST() {
        return LIST;
    }

    public void setLIST(List<MaketDetailModel> LIST) {
        this.LIST = LIST;
    }


    public static class MaketDetailModel {
        ...
        private List<ImageFileInfo> imgList; // - 이미지리스트`
